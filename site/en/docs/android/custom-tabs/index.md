...
Custom Entrance and Exit animations to match the rest of your app
 ...
 {% Img src="image/TODO.gif", alt="A mobile browser, transiting between screens, ending with a web site loaded in a Custom Tab", width="999", height="999" %}

Modifing the toolbar color to match your apps branding

 {% Img src="image/TODO.gif", alt="A mobile browser, transitioning to a Custom Tab with matching colors to the website", width="999", height="999" %}

And that color consistency can stay with your app, even if they switch between Light and Dark themes

 {% Img src="image/TODO.gif", alt="A Custom Tab toggling the color of its toolbar to match the dark theme of the device", width="999", height="999" %}

You can add custom actions and entries to the browser's toolbar, and menus

 {% Img src="image/TODO.jpg", alt="A Custom Tab showing its menu, with custom entries reading TODO", width="999", height="999" %}

Or hide the toolbar all together

 {% Img src="image/TODO.jpg", alt="A Custom Tab, with no visible toolbar", width="999", height="999" %}
...
streaming your videos while interacting with your web store.
 ...
 {% Img src="image/TODO.jpg", alt="", width="999", height="999" %}
